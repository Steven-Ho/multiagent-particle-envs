...
class Scenario(BaseScenario):
    def make_world(self,high_acc=False, random=True, collide_reward=False, shape=True, collide_ratio=10, nl=0, disturb=False, init_pos=[[0,0.8],[-0.7,-0.7],[0.7,-0.7],[0.0,0.0]]):
        world = World()
        self.random=random
